...
namespace OpenTK_Samples
{
	...
	class Game : GameWindow
	{
		...
		Model torus, sphere, plate, sphere2;

		//800x600のウィンドウを作る。タイトルは「1-11:Alpha&Depth Test」
		public Game()
			: base(800, 600, GraphicsMode.Default, "1-11:Alpha&Depth Test")
		{
			...
			sphere.Initialize(new Color4(1.0f, 0.0f, 0.0f, 0.6f));

			plate = new PlateModel(32, 32, 5.0f, -1.0f);
			plate.Initialize(Color4.Black);

			sphere2 = new SphereModel(16, 16, 1.0f);
			sphere2.Initialize(new Color4(0.0f, 1.0f, 0.0f, 0.3f));
