...
namespace OpenTK_Samples
{
	...
	class Game : GameWindow
	{
		...
		//800x600のウィンドウを作る。タイトルは「2-5:Texture Environment」
		public Game()
			: base(800, 600, GraphicsMode.Default, "2-5:Texture Environment")
		{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			//picture.pngの読み込み
			Bitmap file = new Bitmap("02-05_picture.png");
